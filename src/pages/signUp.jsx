...
Formik.propTypes = {
    ...
    initialValues: PropTypes.shape({password: PropTypes.string, confirmPassword: PropTypes.string}),
            ...
            <Container component={'main'} maxWidth={"xs"} sx={{display: "flex", height: '100vh'}}>
                <Formik
                    ...
                    onSubmit={(values, {setSubmitting, setFieldError}) => {
                        ...
                        firebase.auth().currentUser.updatePassword(values.password).then(r => {
                            db.collection("users")
                                .doc(user.uid)
                                .set({
