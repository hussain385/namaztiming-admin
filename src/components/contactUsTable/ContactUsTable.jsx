    ...
    return (
        <>
            ...
            <Modal id="any-unique-identifier" isOpen={isModalOpen}>
                <MessageDisplay handleToast1={() => handleToast1()} handleToast={() => handleToast()} data={data}
...
const MessageDisplay = (props) => {
    ...
    return (
        <>
            ...
            <Modal id="any-unique-identifier" isOpen={isModalOpen}>
                <MessageReply handleToast1={() => props.handleToast1()} handleToast={() => props.handleToast()} data={props.data}
                              preButton={{onClick: closeModal, text: 'Close'}}/>
            </Modal>
        </>
    )
...
const MessageReply = (props) => {
    return (
        <Formik
            ...
            onSubmit={values => {
                emailjs.send("service_nqjmqcg", "template_vpq7rpr", {
                    from_name: "Admin",
